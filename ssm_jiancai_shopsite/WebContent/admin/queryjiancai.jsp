		...
		<div class="wrapper">
			<div class="widget">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="sTable">
					...
					<thead>
						<tr>
							<td class="center">建材名称</td>
							<td class="center">建材类型</td>
					...
					<c:forEach items="${jiancaiList}" var="jiancai">
						<tr align="center">
							<td class="center">${jiancai.jiancainame}</td>
							<td class="center">${jiancai.catename}</td>
							<td class="center">${jiancai.price}</td>
							<td class="center">${jiancai.recommend}</td>
							<td class="center">${jiancai.thestart}</td>
							<td class="center">${jiancai.theend}</td>
							<td class="center">${jiancai.hits}</td>
							<td class="center">${jiancai.sellnum}</td>
						</tr>
					</c:forEach>
				</table>
				<div class="dataTables_wrapper">
					<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix">
						<form action="jiancai/queryJiancaiByCond.action" name="myform" method="post">
							<label>查询条件: <select name="cond" style="width: 100px">
									<option value="jiancainame">按建材名称查询</option>
									<option value="cateid">按建材类型查询</option>
